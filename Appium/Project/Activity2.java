...
public class Activity2 {
    ...
    public void googleKeep() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.id("editable_title")).sendKeys("fullstackTester_Note");
       Thread.sleep(3000);
        driver.findElement(AppiumBy.id("edit_note_text")).sendKeys("Appium fst project");
        ...
        // Assertion
        Assert.assertEquals(result, "fullstackTester_Note");
    }
