...
public class getUrlofHeaderImage {
    public static void main(String[] args) {
       ...
       // WebDriverWait wait=
        ...
        System.out.println("Goal:  Print the url of the header image to the console");
        driver.get("https://alchemy.hguy.co/jobs");
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//header[@class='entry-header ast-no-meta']//div)[1]")));
        String url=driver.findElement(By.xpath("(//header[@class='entry-header ast-no-meta']//div//img)[1]")).getAttribute("src");
